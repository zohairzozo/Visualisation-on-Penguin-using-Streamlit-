...
st.markdown(" > Thank you for exploring palmerpenguins.")


st.sidebar.markdown("[Data Source](https://data.world/makeovermonday/2020w28)")
st.sidebar.info(" [Source Article](https://github.com/allisonhorst/palmerpenguins")
st.sidebar.info("Artwork by [Allison Horst](https://twitter.com/allison_horst) ")
st.sidebar.info("Self Exploratory Visualization on palmerpenguins - Brought To you By [Zohair Ahmed](https://github.com/zohairzozo) ")
